...
import {
  ...
  Headphones, Eye, Waves, RefreshCw, Zap, Move, Baby
} from "lucide-react";
import {
...
const STUDIO_CONFIG = {
  ...
  tagline: "Restore balance. Rediscover inner peace.",
  logoMark: "B",
  description: "Hot yoga, aerial yoga, yin, prenatal, kids yoga, and community meditation in Kirkland and Redmond. A sanctuary for self-discovery.",
  heroLine1: "BE",
  heroLine2: "ONE",
  address: { street: "11220 NE 124th St, Ste 101", city: "Kirkland", state: "WA", zip: "98034" },
  phone: "(425) 820-9642",
  email: "info@beoneyogastudio.com",
  neighborhood: "Kirkland & Redmond",
  website: "https://www.beoneyogastudio.com",
  social: { instagram: "@beoneyogastudiokirkland" },
  locations: [{ name: "Kirkland", type: "yoga" }, { name: "Redmond", type: "yoga" }],
  theme: {
    accent:     { h: 160, s: 42, l: 46 },
    accentAlt:  { h: 30,  s: 50, l: 52 },
    warning:    { h: 0,   s: 55, l: 52 },
    primary:    { h: 165, s: 18, l: 10 },
    surface:    { h: 160, s: 10, l: 97 },
    surfaceDim: { h: 155, s: 8,  l: 93 },
  },
  features: {
    ...
    multiLocation: true, aerialYoga: true, kidsYoga: true, prenatalYoga: true, facials: true,
  },
  classCapacity: 30,
...
const STUDIO_IMAGES = {
  home: "https://static.wixstatic.com/media/41cb34_5b7f031b72284c49bada25557718605f~mv2.jpg/v1/fill/w_1200,h_800,al_c,q_85/41cb34_5b7f031b72284c49bada25557718605f~mv2.jpg",
  classes: "https://static.wixstatic.com/media/41cb34_4fbec60ff2944e8f90d8bfc443919fd4~mv2.jpg/v1/fill/w_1200,h_800,al_c,q_85/41cb34_4fbec60ff2944e8f90d8bfc443919fd4~mv2.jpg",
  schedule: "https://static.wixstatic.com/media/41cb34_7195fa9832e443a5a76a168a587e3ff3~mv2.jpg/v1/fill/w_1200,h_800,al_c,q_85/41cb34_7195fa9832e443a5a76a168a587e3ff3~mv2.jpg",
  practice: "https://static.wixstatic.com/media/41cb34_70b7ba81a73249cba221e74211a75fee~mv2.jpg/v1/fill/w_1200,h_800,al_c,q_85/41cb34_70b7ba81a73249cba221e74211a75fee~mv2.jpg",
  community: "https://static.wixstatic.com/media/41cb34_6fb2d256d938472783aad968e62f49c0~mv2.jpg/v1/fill/w_1200,h_800,al_c,q_85/41cb34_6fb2d256d938472783aad968e62f49c0~mv2.jpg",
  teachers: "https://static.wixstatic.com/media/41cb34_e67d613b3c084336ab7555aee2c820cf~mv2.jpg/v1/fill/w_1200,h_800,al_c,q_85/41cb34_e67d613b3c084336ab7555aee2c820cf~mv2.jpg",
  events: "https://static.wixstatic.com/media/41cb34_e01e460f7fec40adadfcbfb52b3fb9c2~mv2.jpg/v1/fill/w_1200,h_800,al_c,q_85/41cb34_e01e460f7fec40adadfcbfb52b3fb9c2~mv2.jpg",
  membership: "https://static.wixstatic.com/media/41cb34_b5d309fde3ac4295b5256ba3a96ce8ac~mv2.jpg/v1/fill/w_1200,h_800,al_c,q_85/41cb34_b5d309fde3ac4295b5256ba3a96ce8ac~mv2.jpg",
};

const GRADIENTS = {
  home: `linear-gradient(135deg, hsl(160,42%,28%) 0%, hsl(165,18%,12%) 100%)`,
  classes: `linear-gradient(135deg, hsl(30,50%,30%) 0%, hsl(160,30%,18%) 100%)`,
  schedule: `linear-gradient(135deg, hsl(165,25%,22%) 0%, hsl(160,42%,18%) 100%)`,
  community: `linear-gradient(135deg, hsl(0,55%,30%) 0%, hsl(165,18%,14%) 100%)`,
  events: `linear-gradient(135deg, hsl(160,42%,26%) 0%, hsl(30,30%,18%) 100%)`,
  membership: `linear-gradient(135deg, hsl(160,42%,24%) 0%, hsl(0,30%,20%) 100%)`,
};
...
const T = {
  ...
  text: "#141e1c", textMuted: "#506860", textFaint: "#809890",
  border: "#ccdcd8", borderLight: "#e4eeea",
};
...
const TEACHERS = [
  { id: "t1", firstName: "Elena", lastName: "Voss", role: "Lead Teacher", certs: ["E-RYT 500", "Aerial Yoga Certified"], specialties: ["Hot Vinyasa", "Aerial Yoga", "Dynamic Flow"], yearsTeaching: 14, bio: "Elena leads dynamic vinyasa flows and aerial yoga sessions at Be One. Known for creative sequencing that challenges every level while keeping the practice accessible and joyful.", photo: "" },
  { id: "t2", firstName: "Tracy", lastName: "Kim", role: "Teacher", certs: ["RYT-500", "Hot Yoga Specialist"], specialties: ["Hot Hatha", "Hot Hatha 90", "Intermediate Hatha"], yearsTeaching: 10, bio: "Tracy delivers hot hatha classes filled with great energy, support, and encouragement. Her precision in the heated room helps students safely deepen their practice beyond the standard 26 poses.", photo: "" },
  { id: "t3", firstName: "Steve", lastName: "Park", role: "Teacher", certs: ["RYT-200", "Power Vinyasa"], specialties: ["Power Hour", "Hot Vinyasa", "Cardio Sculpt"], yearsTeaching: 8, bio: "Steve brings high-energy instruction to Power Hour and Cardio Sculpt. His fast-paced, music-driven classes leave students buzzing with energy while building full-body strength.", photo: "" },
  { id: "t4", firstName: "Adam", lastName: "Chen", role: "Teacher & Sound Healer", certs: ["RYT-200", "Aerial Sound Bath Facilitator"], specialties: ["Aerial Yoga", "Sound Baths", "Aerial Sound Bath"], yearsTeaching: 6, bio: "Adam facilitates the Aerial Sound Bath experience — a transcendental fusion of silk hammocks and vibrational healing. Students describe his sessions as a transformative self-love ritual.", photo: "" },
  { id: "t5", firstName: "Kami", lastName: "Reeves", role: "Teacher", certs: ["RYT-200", "Yin Certified"], specialties: ["Yin Yoga", "Candlelit Yin", "Vin to Yin"], yearsTeaching: 7, bio: "Kami brings deep calm to her yin and candlelit practices. Her long-held postures target connective tissues while her guided breathwork helps students release layers of tension and find restoration.", photo: "" },
  { id: "t6", firstName: "Em", lastName: "Santos", role: "Studio Manager & Teacher", certs: ["RYT-200", "Prenatal Certified"], specialties: ["Prenatal Yoga", "Foundations Flow", "Roll & Restore"], yearsTeaching: 5, bio: "Em manages the studio with incredible warmth and teaches prenatal and foundations classes. Her Roll & Restore sessions use therapy balls to release tension and restore balance.", photo: "" },
  { id: "t7", firstName: "Amanda", lastName: "East", role: "Kids Yoga Specialist", certs: ["RYT-200", "Blossoming Yogis Certified"], specialties: ["Kids Yoga", "Baby Yoga", "Family Movement"], yearsTeaching: 8, bio: "Amanda leads the Blossoming Yogis program at Be One — prenatal, baby, and toddler yoga. Creating nurturing environments for movement, bonding, and community for young families.", photo: "" },
];

const TODAYS_FOCUS = {
  id: "focus-today", date: today, name: "Hot Hatha (Kirkland)", type: "HOT_HATHA", style: "Hot Hatha", temp: "105\u00b0F", duration: 60,
  description: "The classic heated hatha sequence building strength, flexibility, and balance in a deeply cleansing environment. Professional flooring, clean studio, lavender towels at the end.",
  intention: "Be present. Be patient. Be one with your practice.",
  teacherTip: "Hydrate well before class. The room is fully heated. Rest in savasana whenever needed. Lavender towels are provided after class.",
};

const PAST_PRACTICES = [
  { id: "p-y1", date: offsetDate(-1), name: "Aerial Yoga (Kirkland)", type: "AERIAL", style: "Aerial", temp: "Room Temp", duration: 60, description: "Yoga in the air using silk hammocks. Soar above the ground, stretch and strengthen in ways never imagined. Deeply restorative savasana suspended in your silk cocoon.", intention: "Let go of heaviness. Feel weightless." },
  { id: "p-y2", date: offsetDate(-2), name: "Candlelit Yin (Kirkland)", type: "CANDLELIT", style: "Candlelit Yin", temp: "Room Temp", duration: 60, description: "Peaceful, meditative practice by candlelight. Yin postures, breathwork, and mindfulness. Let go of stress and feel a deep sense of calm wash over you.", intention: "Quiet the mind. Soften the heart." },
  { id: "p-y3", date: offsetDate(-3), name: "Power Hour (Redmond)", type: "POWER", style: "Power Hour", temp: "Heated", duration: 60, description: "High-energy hot yoga. Fast-paced, dynamic movements synced to uplifting music. Wake up to your full potential.", intention: "Unleash your spirit through movement." },
];

const UPCOMING_PRACTICE = { id: "p-tmrw", date: offsetDate(1), name: "Vin to Yin (Kirkland)", type: "VIN_YIN", style: "Vin to Yin", temp: "Warm", duration: 75, description: "The perfect blend of energizing flow and deep grounding stretches. Active vinyasa transitions into long-held yin. Wake up your body. Calm your mind.", intention: "Balance strength with surrender." };

const CLASSES_TODAY = [
  { id: "cl1", time: "06:00", type: "Hot Hatha", coach: "Tracy Kim", location: "Kirkland", capacity: 30, registered: 24, waitlist: 0 },
  { id: "cl2", time: "07:30", type: "Hot Vinyasa", coach: "Elena Voss", location: "Kirkland", capacity: 30, registered: 28, waitlist: 2 },
  { id: "cl3", time: "09:00", type: "Aerial Yoga", coach: "Adam Chen", location: "Kirkland", capacity: 15, registered: 14, waitlist: 3 },
  { id: "cl4", time: "09:00", type: "Hot Hatha", coach: "Steve Park", location: "Redmond", capacity: 25, registered: 18, waitlist: 0 },
  { id: "cl5", time: "10:30", type: "Yin Yoga", coach: "Kami Reeves", location: "Kirkland", capacity: 30, registered: 20, waitlist: 0 },
  { id: "cl6", time: "12:00", type: "Power Hour", coach: "Steve Park", location: "Kirkland", capacity: 30, registered: 22, waitlist: 0 },
  { id: "cl7", time: "16:30", type: "Kids Yoga", coach: "Amanda East", location: "Kirkland", capacity: 15, registered: 10, waitlist: 0 },
  { id: "cl8", time: "17:30", type: "Hot Vinyasa", coach: "Elena Voss", location: "Kirkland", capacity: 30, registered: 30, waitlist: 4 },
  { id: "cl9", time: "19:00", type: "Candlelit Yin", coach: "Kami Reeves", location: "Kirkland", capacity: 30, registered: 26, waitlist: 0 },
];

const WEEKLY_SCHEDULE = [
  { day: "Monday", classes: [{ time: "06:00", type: "Hot Hatha", coach: "Tracy", location: "Kirkland" }, { time: "07:30", type: "Hot Vinyasa", coach: "Elena", location: "Kirkland" }, { time: "09:00", type: "Aerial Yoga", coach: "Adam", location: "Kirkland" }, { time: "09:00", type: "Hot Hatha", coach: "Steve", location: "Redmond" }, { time: "10:30", type: "Yin Yoga", coach: "Kami", location: "Kirkland" }, { time: "12:00", type: "Power Hour", coach: "Steve", location: "Kirkland" }, { time: "17:30", type: "Hot Vinyasa", coach: "Elena", location: "Kirkland" }, { time: "19:00", type: "Candlelit Yin", coach: "Kami", location: "Kirkland" }] },
  { day: "Tuesday", classes: [{ time: "06:00", type: "Hot Hatha", coach: "Tracy", location: "Kirkland" }, { time: "07:30", type: "Hot Vinyasa", coach: "Elena", location: "Kirkland" }, { time: "09:00", type: "Aerial Yoga", coach: "Adam", location: "Kirkland" }, { time: "09:00", type: "Hot Hatha", coach: "Steve", location: "Redmond" }, { time: "10:30", type: "Yin Yoga", coach: "Kami", location: "Kirkland" }, { time: "12:00", type: "Power Hour", coach: "Steve", location: "Kirkland" }, { time: "17:30", type: "Hot Vinyasa", coach: "Elena", location: "Kirkland" }, { time: "19:00", type: "Candlelit Yin", coach: "Kami", location: "Kirkland" }] },
  { day: "Wednesday", classes: [{ time: "06:00", type: "Hot Hatha", coach: "Tracy", location: "Kirkland" }, { time: "07:30", type: "Hot Vinyasa", coach: "Elena", location: "Kirkland" }, { time: "09:00", type: "Aerial Yoga", coach: "Adam", location: "Kirkland" }, { time: "09:00", type: "Hot Hatha", coach: "Steve", location: "Redmond" }, { time: "10:30", type: "Yin Yoga", coach: "Kami", location: "Kirkland" }, { time: "12:00", type: "Power Hour", coach: "Steve", location: "Kirkland" }, { time: "17:30", type: "Hot Vinyasa", coach: "Elena", location: "Kirkland" }, { time: "19:00", type: "Candlelit Yin", coach: "Kami", location: "Kirkland" }] },
  { day: "Thursday", classes: [{ time: "06:00", type: "Hot Hatha", coach: "Tracy", location: "Kirkland" }, { time: "07:30", type: "Hot Vinyasa", coach: "Elena", location: "Kirkland" }, { time: "09:00", type: "Aerial Yoga", coach: "Adam", location: "Kirkland" }, { time: "09:00", type: "Hot Hatha", coach: "Steve", location: "Redmond" }, { time: "10:30", type: "Yin Yoga", coach: "Kami", location: "Kirkland" }, { time: "12:00", type: "Power Hour", coach: "Steve", location: "Kirkland" }, { time: "17:30", type: "Hot Vinyasa", coach: "Elena", location: "Kirkland" }, { time: "19:00", type: "Candlelit Yin", coach: "Kami", location: "Kirkland" }] },
  { day: "Friday", classes: [{ time: "06:00", type: "Hot Hatha", coach: "Tracy", location: "Kirkland" }, { time: "07:30", type: "Hot Vinyasa", coach: "Elena", location: "Kirkland" }, { time: "09:00", type: "Aerial Yoga", coach: "Adam", location: "Kirkland" }, { time: "09:00", type: "Hot Hatha", coach: "Steve", location: "Redmond" }, { time: "10:30", type: "Yin Yoga", coach: "Kami", location: "Kirkland" }, { time: "12:00", type: "Power Hour", coach: "Steve", location: "Kirkland" }, { time: "17:30", type: "Hot Vinyasa", coach: "Elena", location: "Kirkland" }, { time: "19:00", type: "Candlelit Yin", coach: "Kami", location: "Kirkland" }] },
  { day: "Saturday", classes: [{ time: "07:30", type: "Hot Hatha", coach: "Tracy", location: "Kirkland" }, { time: "09:00", type: "Aerial Yoga", coach: "Adam", location: "Kirkland" }, { time: "09:00", type: "Hot Vinyasa", coach: "Steve", location: "Redmond" }, { time: "10:30", type: "Kids Yoga", coach: "Amanda", location: "Kirkland" }, { time: "12:00", type: "Vin to Yin", coach: "Kami", location: "Kirkland" }, { time: "14:00", type: "Prenatal Yoga", coach: "Em", location: "Kirkland" }] },
  { day: "Sunday", classes: [{ time: "09:30", type: "Hot Hatha 90", coach: "Tracy", location: "Kirkland" }, { time: "09:30", type: "Hot Hatha", coach: "Steve", location: "Redmond" }, { time: "11:30", type: "Foundations Flow", coach: "Em", location: "Kirkland" }, { time: "16:00", type: "Candlelit Yin", coach: "Kami", location: "Kirkland" }, { time: "17:30", type: "Free Community Meditation", coach: "Adam", location: "Kirkland" }] },
];

const COMMUNITY_FEED = [
  { id: "cf1", user: "Deanna M.", milestone: "First Aerial", message: "Suspended in the silk cocoon during savasana. Weightless. I genuinely did not want to come down. Adam is magical.", date: today, celebrations: 32 },
  { id: "cf2", user: "Jason B.", milestone: "100 Hot Classes", message: "One hundred heated sessions. Tracy and Steve pushed me further than I thought possible. The lavender towels are earned.", date: today, celebrations: 28 },
  { id: "cf3", user: "Alicia W.", milestone: "30-Day Streak", message: "Thirty days across Kirkland and Redmond. Hot hatha, aerial, candlelit yin — this studio has everything.", date: offsetDate(-1), celebrations: 22 },
  { id: "cf4", user: "Chris T.", milestone: "Aerial Sound Bath", message: "Part yoga, part sound healing, part flying. The Aerial Sound Bath with Adam is unlike anything I have experienced.", date: offsetDate(-2), celebrations: 38 },
];
...
const MILESTONE_BADGES = {
  ...
  "First Aerial": { icon: Zap, color: "#8b5cf6" },
  "Aerial Sound Bath": { icon: Headphones, color: "#3b82f6" },
  "Both Locations": { icon: MapPin, color: T.success },
  "1 Year Member": { icon: Award, color: T.success },
};

const EVENTS = [
  { id: "ev1", name: "Aerial Sound Bath with Adam", date: "2026-05-09", startTime: "19:00", type: "Sound Bath", description: "A transcendental fusion of aerial yoga and vibrational healing. Suspended in silk hammocks while crystal bowls, chimes, and gongs wash over you. Deeply restorative. Deeply transformative.", fee: 45, maxParticipants: 15, registered: 14, status: "Almost Full" },
  { id: "ev2", name: "3rd Anniversary Celebration", date: "2026-06-14", startTime: "17:00", type: "Community Event", description: "90-minute class with live music by DJ Drishti. Elena leads 45 minutes of dynamic vinyasa, Kami brings 45 minutes of yin. Wine and chocolate after. Celebrate the Be One community.", fee: 30, maxParticipants: 40, registered: 22, status: "Registration Open" },
  { id: "ev3", name: "Prenatal Yoga Series: 6 Weeks", date: "2026-05-18", startTime: "10:30", type: "Series", description: "Gentle movement and supportive poses for every stage of pregnancy. Led by Em with the Blossoming Yogis. Connect with your changing body and prepare for birth with intention.", fee: 120, maxParticipants: 12, registered: 6, status: "Registration Open" },
  { id: "ev4", name: "Free Community Meditation", date: offsetDate(6), startTime: "17:30", type: "Community", description: "Open to everyone. No experience needed. A guided meditation to reconnect, ground, and find stillness. Every Sunday at Be One.", fee: 0, maxParticipants: 30, registered: 18, status: "Open" },
];

const MEMBERSHIP_TIERS = [
  { id: "m0", name: "3-Week Intro", type: "intro", price: 59, period: "3 weeks", features: ["Unlimited classes for 21 days", "Both Kirkland and Redmond", "All class types including aerial", "New students only"], popular: false },
  { id: "m1", name: "Drop-In", type: "drop-in", price: 28, period: "per class", features: ["Single class credit", "Any class type", "Either location", "72-hour advance booking"], popular: false },
  { id: "m2", name: "10 Class Pack", type: "pack", price: 240, period: "10 classes", features: ["$24 per class", "12-month expiration", "Any class type", "Both locations"], popular: false },
  { id: "m3", name: "Premium Monthly", type: "unlimited", price: 145, period: "/month", features: ["Unlimited classes both locations", "All 16+ class types", "Aerial yoga included", "Auto-renewing", "$20 late-cancel fee for no-shows"], popular: true },
  { id: "m4", name: "Annual Unlimited", type: "unlimited", price: 1440, period: "/year", annualEquiv: 120, features: ["Unlimited both locations", "Best monthly rate", "All class types", "Guest passes included", "Priority aerial booking"], popular: false },
];

const ANNOUNCEMENTS = [
  { id: "a1", title: "3 Weeks Unlimited for $59", message: "Your journey starts here. All classes, both locations, every style. Hot yoga to aerial to candlelit yin. New students only.", type: "celebration", pinned: true },
  { id: "a2", title: "Free Community Meditation: Sundays", message: "Open to everyone. No experience needed. Reconnect, ground, and find stillness. Every Sunday at 5:30pm in Kirkland.", type: "info", pinned: false },
];

const MEMBERS_DATA = [
  { id: "mem1", name: "Deanna Morrison", email: "deanna@email.com", membership: "Premium Monthly", status: "active", joined: "2024-03-01", checkIns: 268, lastVisit: today },
  { id: "mem2", name: "Jason Balajadia", email: "jason@email.com", membership: "Annual Unlimited", status: "active", joined: "2023-09-15", checkIns: 342, lastVisit: offsetDate(-1) },
  { id: "mem3", name: "Alicia Weyer", email: "alicia@email.com", membership: "Premium Monthly", status: "active", joined: "2024-06-01", checkIns: 198, lastVisit: today },
  { id: "mem4", name: "Chris Torres", email: "chris@email.com", membership: "10 Class Pack", status: "active", joined: "2026-01-15", checkIns: 6, lastVisit: offsetDate(-3) },
  { id: "mem5", name: "Megan Park", email: "megan@email.com", membership: "Premium Monthly", status: "frozen", joined: "2024-11-01", checkIns: 88, lastVisit: offsetDate(-32) },
  { id: "mem6", name: "Raj Patel", email: "raj@email.com", membership: "3-Week Intro", status: "active", joined: "2026-04-06", checkIns: 8, lastVisit: offsetDate(-1) },
];

const ADMIN_METRICS = { activeMembers: 224, memberChange: 12, todayCheckIns: 78, weekCheckIns: 468, monthlyRevenue: 32400, revenueChange: 9.8, renewalRate: 89.4, workshopRevenue: 4200 };

const ADMIN_CHARTS = {
  attendance: [
    { day: "Mon", total: 76, avg: 10 }, { day: "Tue", total: 68, avg: 9 },
    { day: "Wed", total: 72, avg: 9 }, { day: "Thu", total: 70, avg: 9 },
    { day: "Fri", total: 58, avg: 10 }, { day: "Sat", total: 82, avg: 14 },
    { day: "Sun", total: 52, avg: 10 },
  ],
  revenue: [
    { month: "Sep", revenue: 25200 }, { month: "Oct", revenue: 26800 },
    { month: "Nov", revenue: 28200 }, { month: "Dec", revenue: 26400 },
    { month: "Jan", revenue: 29800 }, { month: "Feb", revenue: 31200 },
    { month: "Mar", revenue: 32400 },
  ],
  classPopularity: [
    { name: "6:00 AM", pct: 82 }, { name: "7:30 AM", pct: 94 },
    { name: "9:00 AM", pct: 90 }, { name: "10:30 AM", pct: 68 },
    { name: "12:00 PM", pct: 74 }, { name: "5:30 PM", pct: 98 },
    { name: "7:00 PM", pct: 88 },
  ],
  membershipBreakdown: [
    { name: "Premium Monthly", value: 92, color: T.accent },
    { name: "Annual Unlimited", value: 38, color: T.success },
    { name: "10 Class Pack", value: 42, color: T.warning },
    { name: "Drop-In / Intro", value: 52, color: T.textMuted },
  ],
};
...
function PageHero({ image, title, subtitle, fallbackGradient }) {
  ...
  const gradient = fallbackGradient || `linear-gradient(135deg, hsl(160,42%,28%) 0%, hsl(165,18%,12%) 100%)`;
  return (
...
function TeacherAvatar({ teacher, size = 56 }) {
  ...
  return (
    <div style={{ width: size, height: size, borderRadius: size > 48 ? 14 : 10, background: `linear-gradient(135deg, ${T.accent}, ${T.accentDark})`, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Fraunces', serif", fontSize: size * 0.38, color: "#fff", flexShrink: 0, fontWeight: 600 }}>
...
function SectionHeader({ title, linkText, linkPage }) {
  ...
  return (
    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12, padding: "0 16px" }}>
      <h2 style={{ fontFamily: "'Fraunces', serif", fontSize: 24, margin: 0, fontWeight: 600 }}>{title}</h2>
    ...
    <div onClick={onToggle} style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderLeft: `4px solid ${typeColors[practice.type] || T.accent}`, borderRadius: 12, padding: isFeatured ? "18px 18px" : "14px 16px", cursor: onToggle ? "pointer" : "default" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: isExpanded ? 10 : 0 }}>
        <div>
          ...
          <h3 style={{ fontFamily: "'Fraunces', serif", fontSize: isFeatured ? 26 : 20, margin: 0, color: T.text, fontWeight: 600 }}>{practice.name}</h3>
        </div>
...
function StatBox({ label, value }) {
  return (
    <div style={{ background: T.bgDim, borderRadius: 8, padding: "10px 12px", textAlign: "center" }}>
      ...
      <p style={{ fontFamily: "'Fraunces', serif", fontSize: 22, color: T.text, margin: 0, fontWeight: 700 }}>{value}</p>
    </div>
  );
}
...
function AdminCard({ title, children }) {
  return (
    <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
      <h3 style={{ fontFamily: "'Fraunces', serif", fontSize: 18, color: "#111827", margin: "0 0 14px", fontWeight: 600 }}>{title}</h3>
      {children}
    </div>
  );
}
    ...
    <div>
            ...
            return (
              <div key={c.id} style={{ display: "flex", alignItems: "center", gap: 12, padding: "14px 16px", background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 12 }}>
                <div style={{ textAlign: "center", minWidth: 48 }}>
                  <span style={{ fontFamily: "'Fraunces', serif", fontSize: 22, color: T.text, fontWeight: 600 }}>{fmtTime(c.time).split(":")[0]}</span>
      ...
      {ANNOUNCEMENTS.length > 0 && (
        <section style={{ marginTop: 28, padding: "0 16px" }}>
          <h2 style={{ fontFamily: "'Fraunces', serif", fontSize: 24, margin: "0 0 12px", fontWeight: 600 }}>Announcements</h2>
      ...
      <section style={{ padding: "16px 16px 8px", marginTop: 20 }}>
        <div style={{ background: `linear-gradient(165deg, ${T.bg}, hsl(30,20%,14%))`, borderRadius: 16, padding: "24px 20px", color: "#fff", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative" }}>
            <h3 style={{ fontFamily: "'Fraunces', serif", fontSize: 24, margin: "0 0 6px", fontWeight: 600 }}>New to Be One?</h3>
            <p style={{ fontSize: 13, color: "#b8a898", margin: "0 0 16px", lineHeight: 1.5 }}>Try us for 3 weeks unlimited for just $59. Both locations. All class types including aerial.</p>
            <button onClick={() => {}} style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "10px 20px", borderRadius: 8, border: "none", background: T.accent, color: "#fff", fontFamily: "'Fraunces', serif", fontSize: 15, cursor: "pointer", fontWeight: 600 }}>View Memberships <ChevronRight size={16} /></button>
          </div>
        </div>
      </section>
    </div>
...
function ClassesPage() {
  ...
  return (
    <div>
      <PageHero image={STUDIO_IMAGES.classes} title="Classes" subtitle="Warm vinyasa, yin, restorative, sound baths, meditation and more" />
      ...
      <div style={{ padding: "20px 16px 0" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          {WEEKLY_SCHEDULE[selectedDay]?.classes.map((cls, i) => {
            const isSpecial = cls.type.includes("Aerial") || cls.type.includes("Kids") || cls.type.includes("Prenatal") || cls.type.includes("Candlelit") || cls.type.includes("Community");
            return (
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, padding: "14px 16px", background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 12 }}>
                <div style={{ textAlign: "center", minWidth: 54 }}>
                  <span style={{ fontFamily: "'Fraunces', serif", fontSize: 16, color: T.text, fontWeight: 600 }}>{fmtTime(cls.time)}</span>
                </div>
                <div style={{ flex: 1 }}>
    ...
    <div>
      ...
      <div style={{ padding: "20px 16px 0" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginBottom: 20 }}>
          {[
            ...
            <div key={i} style={{ background: s.ghost, border: `1px solid ${s.bdr}`, borderRadius: 12, padding: "14px 10px", textAlign: "center" }}>
              ...
              <div style={{ fontFamily: "'Fraunces', serif", fontSize: 28, fontWeight: 700, color: T.text }}>{s.val}</div>
        ...
        {activeTab === "log" && (
          <div style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 12, padding: 20 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <button onClick={() => { setSaved(true); setTimeout(() => setSaved(null), 2000); setReflection({ energy: 4, focus: 4, notes: "" }); }} style={{ padding: "12px 0", borderRadius: 8, border: "none", fontWeight: 700, cursor: "pointer", background: T.accent, color: "#fff", fontFamily: "'Fraunces', serif", fontSize: 17 }}>
        ...
        <div style={{ marginTop: 24 }}>
          <h3 style={{ fontFamily: "'Fraunces', serif", fontSize: 22, margin: "0 0 12px", fontWeight: 600 }}>Recent Practice</h3>
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {[
      ...
      <div style={{ padding: "20px 16px 0" }}>
        {STUDIO_CONFIG.features.guestPasses && (
          <div style={{ background: `linear-gradient(135deg, ${T.bg}, hsl(30,20%,14%))`, borderRadius: 14, padding: "18px", marginBottom: 20, color: "#fff" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}><Gift size={20} color={T.accent} /><h3 style={{ fontFamily: "'Fraunces', serif", fontSize: 18, margin: 0, fontWeight: 600 }}>Guest Passes</h3></div>
            ...
            return (
              <div key={item.id} style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 14, padding: "16px 18px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                  <div style={{ width: 40, height: 40, borderRadius: "50%", background: `linear-gradient(135deg, ${T.accent}, ${T.accentDark})`, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Fraunces', serif", fontSize: 16, color: "#fff", fontWeight: 700, flexShrink: 0 }}>{item.user[0]}</div>
...
function TeachersPage() {
  ...
  return (
    <div>
      <PageHero image={STUDIO_IMAGES.teachers} title="Teachers" subtitle="Compassionate instructors across Kirkland and Redmond" />
      <div style={{ padding: "20px 16px 0", display: "flex", flexDirection: "column", gap: 12 }}>
      ...
      <div style={{ padding: "20px 16px 0", display: "flex", flexDirection: "column", gap: 12 }}>
        {MEMBERSHIP_TIERS.map(tier => (
          <div key={tier.id} style={{ background: T.bgCard, border: `1px solid ${tier.popular ? T.accent : T.border}`, borderRadius: 14, padding: "20px 18px", position: "relative", overflow: "hidden" }}>
            ...
            <h3 style={{ fontFamily: "'Fraunces', serif", fontSize: 22, margin: "0 0 4px", color: T.text, fontWeight: 600 }}>{tier.name}</h3>
            <div style={{ display: "flex", alignItems: "baseline", gap: 4, marginBottom: 12 }}>
              <span style={{ fontFamily: "'Fraunces', serif", fontSize: 38, color: T.accent, fontWeight: 700 }}>${tier.price}</span>
            ...
            <button style={{ width: "100%", padding: "12px 0", borderRadius: 8, border: "none", fontSize: 16, fontWeight: 700, cursor: "pointer", fontFamily: "'Fraunces', serif", background: tier.popular ? T.accent : T.bg, color: "#fff" }}>Get Started</button>
          </div>
        ))}
      </div>
    </div>
        ...
        {EVENTS.map(ev => (
          <div key={ev.id} style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 14, overflow: "hidden", marginBottom: 16 }}>
            <div style={{ background: `linear-gradient(135deg, ${T.bg}, hsl(30,20%,14%))`, padding: "20px 18px", color: "#fff" }}>
              ...
              <h3 style={{ fontFamily: "'Fraunces', serif", fontSize: 20, margin: "6px 0 4px", fontWeight: 600 }}>{ev.name}</h3>
            ...
            <div style={{ padding: "16px 18px" }}>
              ...
              <button style={{ width: "100%", padding: "12px 0", borderRadius: 8, border: "none", fontSize: 16, fontWeight: 700, cursor: "pointer", fontFamily: "'Fraunces', serif", background: T.accent, color: "#fff" }}>Register Now</button>
            </div>
          </div>
        ))}
      </div>
...
function AdminDashboard() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div><h1 style={{ fontFamily: "'Fraunces', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Dashboard</h1><p style={{ fontSize: 13, color: "#6b7280", margin: "4px 0 0" }}>Welcome back. Here is what is happening at Be One.</p></div>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 14 }}>
        {metrics.map((m, i) => (
          <div key={i} style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
            ...
            <div style={{ fontFamily: "'Fraunces', serif", fontSize: 30, color: "#111827", fontWeight: 700 }}>{m.value}</div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 14 }}>
        ...
        <AdminCard title="Recent Activity">
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            {[{ text: "New member signup", detail: "Raj Patel - 3-Week Intro", time: "5 min ago", color: T.accent },{ text: "Workshop registration", detail: "Aerial Sound Bath - Chris T.", time: "12 min ago", color: "#8b5cf6" },{ text: "Class waitlist full", detail: "7:30 AM Hot Vinyasa (Kirkland)", time: "18 min ago", color: T.success },{ text: "Payment received", detail: "Premium Monthly - Deanna Morrison", time: "25 min ago", color: T.warning },{ text: "Guest pass redeemed", detail: "Deanna Morrison's guest", time: "1 hr ago", color: "#3b82f6" }].map((a, i) => (
...
function AdminMembersPage() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Fraunces', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Members</h1><CrudBar addLabel="Add Member" /></div>
...
function AdminSchedulePage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Fraunces', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Schedule</h1><CrudBar addLabel="Add Class" /></div>
      <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, overflow: "hidden" }}>
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
...
function AdminTeachersPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Fraunces', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Teachers</h1><CrudBar addLabel="Add Teacher" /></div>
...
function AdminEventsPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Fraunces', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Events & Workshops</h1><CrudBar addLabel="New Event" /></div>
      {EVENTS.map(ev => (
        <div key={ev.id} style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 8 }}>
              <div style={{ textAlign: "right" }}><div style={{ fontFamily: "'Fraunces', serif", fontSize: 28, color: T.accent, fontWeight: 700 }}>{ev.registered}</div><p style={{ fontSize: 11, color: "#6b7280" }}>of {ev.maxParticipants}</p></div>
              <CrudActions />
            </div>
          </div>
        </div>
...
function AdminPricingPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Fraunces', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Pricing & Memberships</h1><CrudBar addLabel="Add Tier" /></div>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: 14 }}>
        {MEMBERSHIP_TIERS.map(tier => (
          <div key={tier.id} style={{ background: "#fff", border: `1px solid ${tier.popular ? T.accent : "#e5e7eb"}`, borderRadius: 12, padding: 18 }}>
            ...
            <h3 style={{ fontFamily: "'Fraunces', serif", fontSize: 20, color: "#111827", margin: "0 0 4px", fontWeight: 600 }}>{tier.name}</h3>
            <div style={{ fontFamily: "'Fraunces', serif", fontSize: 32, color: T.accent, fontWeight: 700 }}>${tier.price}<span style={{ fontSize: 14, color: "#6b7280", fontWeight: 400 }}> {tier.period}</span></div>
...
function AdminBroadcastPage() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <h1 style={{ fontFamily: "'Fraunces', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Broadcast</h1>
      <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
...
function AdminSettingsPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <h1 style={{ fontFamily: "'Fraunces', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Studio Settings</h1>
        ...
        {!confirmed ? (
          <>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
              <h2 style={{ fontFamily: "'Fraunces', serif", fontSize: 24, margin: 0, color: T.text, fontWeight: 600 }}>Confirm Reservation</h2>
            ...
            <div style={{ background: T.bgDim, borderRadius: 14, padding: "18px 16px", marginBottom: 20 }}>
              ...
              <div style={{ marginTop: 16, display: "flex", flexDirection: "column", gap: 10 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}><MapPin size={16} color={T.textMuted} /><span style={{ fontSize: 14, color: T.text }}>11220 NE 124th St, Kirkland</span></div>
              </div>
            </div>
            <div style={{ background: T.accentGhost, border: `1px solid ${T.accentBorder}`, borderRadius: 10, padding: "12px 14px", marginBottom: 20 }}>
              ...
              <p style={{ fontSize: 12, color: "#5a5040", margin: "0 0 4px", lineHeight: 1.4 }}>$20 late-cancel or no-show fee. 2-hour cancellation window.. Cancel at least 2 hours before class to avoid fees.</p>
              <p style={{ fontSize: 12, color: "#5a5040", margin: 0, lineHeight: 1.4 }}>72-hour advance registration. Doors lock at class start. Hot rooms available..</p>
            </div>
            <button onClick={() => { setConfirmed(true); onConfirm(classData.id); }} style={{ width: "100%", padding: "14px 0", borderRadius: 10, border: "none", fontSize: 17, fontWeight: 700, cursor: "pointer", fontFamily: "'Fraunces', serif", background: isFull ? T.success : T.accent, color: "#fff", marginBottom: 8 }}>{isFull ? "Join Waitlist" : "Confirm Reservation"}</button>
          ...
          <div style={{ textAlign: "center", padding: "10px 0" }}>
            ...
            <h2 style={{ fontFamily: "'Fraunces', serif", fontSize: 24, margin: "0 0 4px", color: T.text, fontWeight: 600 }}>{isFull ? "Added to Waitlist" : "You're In!"}</h2>
            ...
            <button onClick={onClose} style={{ width: "100%", padding: "14px 0", borderRadius: 10, border: "none", fontSize: 17, fontWeight: 700, cursor: "pointer", fontFamily: "'Fraunces', serif", background: T.accent, color: "#fff" }}>Done</button>
          </div>
        )}
      </div>
      ...
      <div onClick={e => e.stopPropagation()} style={{ background: T.bgCard, borderRadius: "20px 20px 0 0", width: "100%", maxWidth: 390, maxHeight: "85vh", overflow: "auto", padding: "20px 20px 40px" }}>
        ...
        <div style={{ padding: "14px 0", borderBottom: `1px solid ${T.borderLight}` }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <div style={{ width: 48, height: 48, borderRadius: 12, background: `linear-gradient(135deg, ${T.accent}, ${T.accentDark})`, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Fraunces', serif", fontSize: 20, color: "#fff", fontWeight: 700 }}>DM</div>
            <div><p style={{ fontWeight: 700, margin: 0, fontSize: 15 }}>Deanna Morrison</p><p style={{ fontSize: 12, color: T.textMuted, margin: "2px 0 0" }}>Premium Monthly — Since Mar 2024</p></div>
          </div>
        </div>
        <div style={{ padding: "14px 0", borderBottom: `1px solid ${T.borderLight}` }}>
...
function NotificationsModal({ onClose }) {
  const notifications = [
    { id: 1, title: "Tomorrow: Vin to Yin", message: "Energizing flow into deep grounding stretches. 75 min. Kirkland.", type: "class", time: "2 hours ago", read: false },
    { id: 2, title: "New Milestone!", message: "Deanna M. completed first Aerial. Celebrate together!", type: "community", time: "4 hours ago", read: false },
    { id: 3, title: "Class Reminder", message: "Reserved for 7:30 AM Hot Vinyasa (Kirkland) with Elena.", type: "class", time: "6 hours ago", read: true },
    { id: 4, title: "Aerial Sound Bath", message: "Silk hammocks + crystal bowls with Adam. May 9th. Almost full.", type: "event", time: "1 day ago", read: true },
  ];
  return (
    <div onClick={onClose} style={{ position: "absolute", inset: 0, background: "rgba(0,0,0,.5)", backdropFilter: "blur(4px)", zIndex: 100, display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
...
//  MAIN APP
// ═══════════════════════════════════════════════════════════════
export default function App({ startInAdmin, onEnterAdmin, onExitAdmin }) {
  ...
  const enterAdmin = useCallback(() => { setIsAdmin(true); setPage("admin-dashboard"); if (onEnterAdmin) onEnterAdmin(); }, [onEnterAdmin]);
  const exitAdmin = useCallback(() => { setIsAdmin(false); setPage("home"); if (onExitAdmin) onExitAdmin(); }, [onExitAdmin]);
  ...
  if (isAdmin) {
    return (
      <AppContext.Provider value={{ page, setPage, classRegistrations, registerForClass, openReservation, feedCelebrations, celebrateFeed }}>
        <div style={{ display: "flex", width: "100vw", height: "100vh", fontFamily: "'Work Sans', system-ui, sans-serif", background: "#f3f4f6" }}>
          <aside style={{ width: 240, background: "#fff", borderRight: "1px solid #e5e7eb", display: "flex", flexDirection: "column", flexShrink: 0 }}>
            <div style={{ padding: "16px 14px", borderBottom: "1px solid #e5e7eb" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <div style={{ width: 32, height: 32, borderRadius: 8, background: T.accent, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Fraunces', serif", fontSize: 14, color: "#fff", fontWeight: 700 }}>{STUDIO_CONFIG.logoMark}</div>
                <div><span style={{ fontFamily: "'Fraunces', serif", fontSize: 16, display: "block", lineHeight: 1, fontWeight: 600, color: "#111827" }}>{STUDIO_CONFIG.name}</span><span style={{ fontSize: 8, color: "#9ca3af", textTransform: "uppercase", letterSpacing: "0.15em" }}>Admin</span></div>
              </div>
            </div>
            ...
            <div style={{ borderTop: "1px solid #e5e7eb", padding: "8px 6px" }}>
              <button onClick={exitAdmin} style={{ display: "flex", alignItems: "center", gap: 8, width: "100%", padding: "8px 10px", borderRadius: 8, border: "none", background: "transparent", color: "#6b7280", fontSize: 13, cursor: "pointer", textAlign: "left" }}><LogOut size={16} /><span>Exit Admin</span></button>
            </div>
          </aside>
  ...
  return (
    <AppContext.Provider value={{ page, setPage, classRegistrations, registerForClass, openReservation, feedCelebrations, celebrateFeed }}>
      <div style={{ position: "relative", width: "100%", height: "100%", background: T.bgDim, fontFamily: "'Work Sans', system-ui, sans-serif", overflow: "hidden" }}>
        <header style={{ position: "absolute", top: 0, left: 0, right: 0, height: 54, background: T.bg, color: "#fff", padding: "0 14px", display: "flex", alignItems: "center", justifyContent: "space-between", zIndex: 30 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <div style={{ width: 34, height: 34, borderRadius: 8, background: T.accent, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Fraunces', serif", fontSize: 14, color: "#fff", fontWeight: 700 }}>{STUDIO_CONFIG.logoMark}</div>
            <div style={{ display: "flex", flexDirection: "column" }}>
              <span style={{ fontFamily: "'Fraunces', serif", fontSize: 18, lineHeight: 1, fontWeight: 600 }}>{STUDIO_CONFIG.name}</span>
        ...
        <main ref={contentRef} style={{ position: "absolute", top: 54, left: 0, right: 0, bottom: 64, overflowY: "auto", overflowX: "hidden", scrollbarWidth: "none", msOverflowStyle: "none" }}>{renderPage()}</main>
        ...
        {showMore && (
          <div onClick={() => setShowMore(false)} style={{ position: "absolute", inset: 0, background: "rgba(0,0,0,.5)", backdropFilter: "blur(4px)", zIndex: 40 }}>
            <div onClick={e => e.stopPropagation()} style={{ position: "absolute", bottom: 68, left: 16, right: 16, background: T.bgCard, borderRadius: 16, padding: "14px 12px", boxShadow: "0 8px 32px rgba(0,0,0,.15)" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "0 6px 8px" }}><span style={{ fontFamily: "'Fraunces', serif", fontSize: 20, fontWeight: 600 }}>More</span><button onClick={() => setShowMore(false)} style={{ padding: 4, borderRadius: 6, border: "none", background: "transparent", cursor: "pointer" }}><X size={18} color={T.textMuted} /></button></div>
